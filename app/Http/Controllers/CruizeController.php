...
class CruizeController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('cruize.index')->with('success', 'Cruize updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('cruize.index')->with('success', 'Cruize deleted successfully');
    }
    ...
    */
    ...
    public function postCruizes(Request $request)
    {
        ...
        Cruize::insert($cruizes);
        return response()->json($cruizes, 200, array(), JSON_PRETTY_PRINT);
    }
